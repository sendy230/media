...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5943219993:AAHlacHeCWVoD7Ao3dvEXoPSGRK2jMVlqPE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001876747964"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5047866686"))

#Port
PORT = os.environ.get("PORT", "3112")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "aseerddds")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001556220914"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5776059273 5511211180 5530142462").split()):
        ADMINS.append(int(x))
except ValueError:
