...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5866757446:AAGmZt8sojByfq_6xzVvZezTYet9sYqE0W0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001627644351"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "2018095690"))

#Port
PORT = os.environ.get("PORT", "1902")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "assembly")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001748946481"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1862995644").split()):
        ADMINS.append(int(x))
except ValueError:
