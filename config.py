...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5933627702:AAFT827viM-x9WkYiWQwogquCnCh2B-RPDA")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001631836008"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "2018095690"))

#Port
PORT = os.environ.get("PORT", "1212")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "asdwwgggb")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001739301260"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "2018095690").split()):
        ADMINS.append(int(x))
except ValueError:
