...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5933017680:AAGfzP_2heuCov0cxnNQj3FSicz4yHhwTVE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001852749200"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1823080600"))

#Port
PORT = os.environ.get("PORT", "2765")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "adlt")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001838555192"))
