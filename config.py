...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6476192014:AAFGTznC9zRHuroKC6JdnEgGWF8VzEQ0EyA")
...
#Port
PORT = os.environ.get("PORT", "7549")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://makan:makan@cluster0.og6i2.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "media")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "1967364224 6282946877").split()):
        ADMINS.append(int(x))
except ValueError:
