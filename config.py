...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5324411690:AAGGPvK-PLb4XJpp2tIfN7Itf-Sr1VY09jU")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001722604919"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1749162554"))

#Port
PORT = os.environ.get("PORT", "3022")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "asdfvvd")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001676860169"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1749162554").split()):
        ADMINS.append(int(x))
except ValueError:
