...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5530804721:A4721:AAHxY12qSHU_tRacyow5_7gRFd8B43lBk3c")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001571954218"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "asdsssfvvd")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-100176285507"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5047866686 2018095690 1850233338").split()):
        ADMINS.append(int(x))
except ValueError:
