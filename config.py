...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6465449893:AAGMgkeMA6Z0lxt77MqQss9OqRtGrd6ctik")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001840963985"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001550374823"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5145607305 2018095690 5047866686 2072769117").split()):
        ADMINS.append(int(x))
except ValueError:
