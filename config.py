...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5460830681:AAHNfflvogj5-gR8AH9bjF1NrPvXtktc8sc")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1850233338 5047866686 2072769117 2018095690").split()):
        ADMINS.append(int(x))
except ValueError:
